...
public class ImageUtils {
    ...
    public static int rotateDegree(String photoPath) {
        int degree = 0;
        try {
            ExifInterface exif = new ExifInterface(photoPath);//获取拍摄信息
    ...
    public static Bitmap resizeWithRotate(Context context, Uri uri, int maxSize) {
        String filePath = ImagePickerUtil.getPath(context, uri);
     ...
     * @return A bitmap sampled down from the original load the same aspect ratio and dimensions
     * that are equal to or greater than the requested width and height
     */
    public static Bitmap decodeSampledBitmapFromFile(String filePath, int reqWidth, int reqHeight) {
        // First decode load inJustDecodeBounds=true to check dimensions
        ...
        // Decode bitmap load inSampleSize set
     ...
     *
     * @param options   An options object load out* params already populated (run through a decode*
     *                  method load inJustDecodeBounds==true
     * @param reqWidth  The requested width of the resulting bitmap
     * @param reqHeight The requested height of the resulting bitmap
    ...
    public static int calculateInSampleSize(BitmapFactory.Options options, int reqWidth, int reqHeight) {
        ...
        if (height > reqHeight || width > reqWidth) {
            ...
            // be more aggressive load sample down the image (=larger inSampleSize).
