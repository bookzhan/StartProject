 ...
 * 说明:
 */
public class NoProgressPlayControl extends DefaultControls {
    ...
    public NoProgressPlayControl(Context context) {
        this(context, null);
    }

    public NoProgressPlayControl(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NoProgressPlayControl(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setFullScreen() {
        ...
        rl_top_control.getLayoutParams().height= DensityUtil.dip2px(getContext(), 70);
    ...
    private void quitFullScreen() {
        ...
        rl_top_control.getLayoutParams().height=DensityUtil.dip2px(getContext(), 55);
